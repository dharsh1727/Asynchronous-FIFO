...
Since `wclk` and `rclk` are independent, direct transfer of multi-bit pointers can cause metastability. To avoid this:
...
So, the read side observes valid written data after a small expected latency.
